...
const namespaceValidFixtureName = "prefer-type-fest-tuple-of.namespace.valid.ts";
...
ruleTester.run("prefer-type-fest-tuple-of", getPluginRule("prefer-type-fest-tuple-of"), {
    invalid: [
        {
