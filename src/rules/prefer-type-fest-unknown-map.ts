...
const hasUnknownMapTypeArguments = (node: TSESTree.TSTypeReference): boolean => {
...
const preferTypeFestUnknownMapRule: ReturnType<typeof createTypedRule> = createTypedRule({
